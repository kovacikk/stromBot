        ...
        if (len(query)  == 0):
            ...
            if (len(matching) == 0):
                ...
                if (not listBool):
                    ...
                    embed.add_field(name="Listing Results for: " + args, value='**-----------------------**\n' + result, inline=True)                    
                    ...
                    def check(reaction, user):
                        if (user == ctx.author):
                           ...
                           if len(matching) - listNumber >= 10:
                               ...
                               listNumber = len(matching) - listNumber
                           ...
                           embed = discord.Embed(color = 0xeeeeee)
                           embed.add_field(name="Listing: " + args, value=result, inline=True)                    
                           embed.add_field(name="-------------", value='Viewing ' + str(listNumber) + ' of ' + str(len(matching)), inline=False)
